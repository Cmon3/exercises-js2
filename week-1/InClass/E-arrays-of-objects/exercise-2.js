...
let destinationNamesMoreThan300KmsAwayByTrain = travelDestinations.filter(dest => dest.distanceKms > 300 && dest.transportations.includes("train")).map(dest => dest.destinationName);// Complete here (PRINT THE RESULT IN THE CONSOLE USING FOREACH)
